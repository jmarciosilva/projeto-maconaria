...
final class AtualizarPaginaInstitucionalRequest extends FormRequest
{
    ...
    {
        $pagina = $this->route('pagina');

        return [
            'slug' => ['required', 'string', 'max:100', 'regex:/^[a-z0-9]+(-[a-z0-9]+)*$/', Rule::unique('paginas_institucionais', 'slug')->ignore($pagina->id)],
