...
final class CriarIrmaoRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', Irmao::class) === true;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'cpf' => ['required', 'string', new CpfValido, Rule::unique('irmaos', 'cpf')],
            ...
            'usuario_id' => [
                ...
                function (string $attribute, mixed $value, \Closure $fail): void {
                    if ($value && User::query()->whereKey($value)->whereNotNull('irmao_id')->exists()) {
