<x-layouts.admin titulo="Novo usuário">
    <form method="POST" action="{{ route('admin.usuarios.store') }}" class="max-w-3xl">
        @csrf
        ...
        <section class="mt-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <label class="flex items-center justify-between gap-3 rounded-md border border-gray-200 px-4 py-3">
                <span class="text-sm font-medium text-gray-700">Exigir alteração de senha no primeiro acesso</span>
